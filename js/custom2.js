...
function getTaluka(dtncode) {
	...
	$.ajax({
		url: "http://gis.mahapocra.gov.in/weatherservices/meta/dtaluka?dtncode=" + dtncode, success: function (result) {
			for (var i = 0; i < result.taluka.length; i++) {
				ele.innerHTML = ele.innerHTML +
...
function querym(layerName, paramName, paramValue, labelname) {
	...
	if (geojsonm) {
		...
		geojsonm.getSource().on('addfeature', function () {
			//alert(geojson.getSource().getExtent());
			mapm.getView().fit(
				geojsonm.getSource().getExtent(),
				{ duration: 1590, size: mapm.getSize() - 100 }
			);
		});
		...
		<td colspan="3" style="text-align: left;font-size: 14px;background-color:#e6e5df">'+ farmtype + '</td>\n\
				...
				for (var j = 0; j < testResult.length; j++) {
					if (testResult[j].testparamname === "pH") {
						...
						ph = '<tr style="font-size:14px"><td style="font-size:14px">' + (j + 1) + '</td><td style="font-size:14px">सामू </td><td style="font-size:14px">' + testResult[j].testvalue + '</td><td style="font-size:14px"> </td><td style="font-size:14px">' + avlph + '</td></tr>';
					}
					...
					if (testResult[j].testparamname === "EC") {
						...
						ec = '<tr style="font-size:14px"><td style="font-size:14px">' + (j + 1) + '</td><td style="font-size:14px">क्षारता  </td><td style="font-size:14px">' + testResult[j].testvalue + '</td><td style="font-size:14px">डीएस/एम </td><td style="font-size:14px">' + avlec + '</td></tr>';
					}
					if (testResult[j].testparamname === "Organic Carbon (OC)") {
						...
						oc = '<tr style="font-size:14px"><td style="font-size:14px">' + (j + 1) + '</td><td style="font-size:14px">सेंद्रिय कर्ब  </td><td style="font-size:14px">' + testResult[j].testvalue + '</td><td style="font-size:14px">%</td><td style="font-size:14px">' + avloc + '</td></tr>';
					}
					...
					if (testResult[j].testparamname === "Available Nitrogen (N)") {
						...
						an = '<tr style="font-size:14px"><td style="font-size:14px">' + (j + 1) + '</td><td style="font-size:14px">उपलब्ध नत्र  </td><td style="font-size:14px">' + testResult[j].testvalue + '</td><td style="font-size:14px">कि.ग्रॅ/हे. </td><td style="font-size:14px">' + avlan + '</td></tr>';
					}
					if (testResult[j].testparamname === "Available Phosphorus (P)") {
						...
						aph = '<tr style="font-size:14px"><td style="font-size:14px">' + (j + 1) + '</td><td style="font-size:14px">उपलब्ध स्फुरद  </td><td style="font-size:14px">' + testResult[j].testvalue + '</td><td style="font-size:14px">कि.ग्रॅ/हे.</td><td style="font-size:14px">' + avlaph + '</td></tr>';
					}
					if (testResult[j].testparamname === "Available Potassium (K)") {
						...
						apo = '<tr style="font-size:14px"><td style="font-size:14px">' + (j + 1) + '</td><td style="font-size:14px">उपलब्ध पालाश  </td><td style="font-size:14px">' + testResult[j].testvalue + '</td><td style="font-size:14px">कि.ग्रॅ/हे.</td><td style="font-size:14px">' + avlapo + '</td></tr>';
					}
					if (testResult[j].testparamname === "Available Sulphur (S)") {
						...
						asu = '<tr style="font-size:14px"><td style="font-size:14px">' + (j + 1) + '</td><td style="font-size:14px">उपलब्ध गंधक (S) </td><td style="font-size:14px">' + testResult[j].testvalue + '</td><td style="font-size:14px">पीपीएम </td><td style="font-size:14px">' + avlasu + '</td></tr>';
					}
					if (testResult[j].testparamname === "Available Zinc (Zn)") {
						...
						azn = '<tr style="font-size:14px"><td style="font-size:14px">' + (j + 1) + '</td><td style="font-size:14px">उपलब्ध जस्त (Zn)  </td><td style="font-size:14px">' + testResult[j].testvalue + '</td><td style="font-size:14px">पीपीएम </td><td style="font-size:14px">' + avlazn + '</td></tr>';
					}
					if (testResult[j].testparamname === "Available Boron (B)") {
						...
						abr = '<tr style="font-size:14px"><td style="font-size:14px">' + (j + 1) + '</td><td style="font-size:14px">उपलब्ध बोरॉन(B)  </td><td style="font-size:14px">' + testResult[j].testvalue + '</td><td style="font-size:14px">पीपीएम</td><td style="font-size:14px">' + avlabr + '</td></tr>';
					}
					...
					if (testResult[j].testparamname === "Available Iron (Fe)") {
						...
						air = '<tr style="font-size:14px"><td style="font-size:14px">' + (j + 1) + '</td><td style="font-size:14px"> उपलब्ध लोह (Fe)  </td><td style="font-size:14px">' + testResult[j].testvalue + '</td><td style="font-size:14px">पीपीएम </td><td style="font-size:14px">' + avlair + '</td></tr>';
					}
					if (testResult[j].testparamname === "Available Manganese (Mn)") {
						...
						amn = '<tr style="font-size:14px"><td style="font-size:14px">' + (j + 1) + '</td><td style="font-size:14px">उपलब्ध मँगनीज(Mn)</td><td style="font-size:14px">' + testResult[j].testvalue + '</td><td style="font-size:14px">पीपीएम</td><td style="font-size:14px">' + avlamn + '</td></tr>';
					}
...
function loadshcDetails1(pin) {
	...
	if (document.getElementById("district").value === "-1") {
		...
		$.ajax({
			url: "http://gis.mahapocra.gov.in/weatherservices/meta/shcbasicinfo?vincode=" + villagecode + "&pinno=" + pin, success: function (result) {
				for (var i = 0; i < result.basicInfo.length; i++) {
					table.row.add([
						i + 1,
						// result.basicInfo[i].district,
...
function printshc() {
	...
	window.open("https://ilab-ffs.mahapocra.gov.in/generatepdf/" + shc);
}
function printshcm() {
