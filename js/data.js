		...
		var OSM = new ol.layer.Tile({
         ...
         // extent: [-180, -90, -180, 90],
          source: new ol.source.ImageWMS({
            url: 'http://gis.mahapocra.gov.in/geoserver/wms',
            params: {'LAYERS': 'PoCRA:Taluka'},
            ratio: 1,
...
var layerSwitcher = new ol.control.LayerSwitcher({
  ...
  map.addControl(layerSwitcher);
      ...
      // alert()
		ar.push("http://gis.mahapocra.gov.in/geoserver/wms?REQUEST=GetLegendGraphic&VERSION=1.0.0&FORMAT=image/png&WIDTH=20&HEIGHT=20&LAYER="+overlays.getLayers().item(i).get('title'));
...
$( "#wms_layers_window" ).show();
    ...
    $(document).ready(function(){
           $.ajax({
               type: "GET",
               url: "http://gis.mahapocra.gov.in/geoserver/wms?request=getCapabilities",
               dataType: "xml",
...
var name = layer_name.split(":");
		...
		var url = 'http://gis.mahapocra.gov.in/geoserver/wms?request=getCapabilities';
...
// layers_name
			...
			$.ajax({
				type: "GET",
				url: "http://gis.mahapocra.gov.in/geoserver/wfs?request=getCapabilities",
				dataType: "xml",
				success: function(xml) {
					var select = $('#layer');
...
attributes.options[0] = new Option('Select attributes', "");
		//  alert(url);
			...
			$.ajax({
				type: "GET",
				url: "http://gis.mahapocra.gov.in/geoserver/wfs?service=WFS&request=DescribeFeatureType&version=1.1.0&typeName="+value_layer,
				dataType: "xml",
				success: function(xml) {
...
//alert(value_txt);
 ...
 var url = "http://gis.mahapocra.gov.in/geoserver/ows?service=WFS&version=1.0.0&request=GetFeature&typeName="+value_layer+"&CQL_FILTER="+value_attribute+"+"+value_operator+"+'"+value_txt+"'&outputFormat=application/json"
// alert(url);
// console.log(url)
